-- =====================================================
-- MIGRACIÓN SQL SEGURA - NO FALLA SI YA EXISTE
-- Solo crea las tablas y tipos que FALTAN
-- =====================================================

-- =====================================================
-- 1. TIPO user_role (solo si no existe)
-- =====================================================
...
-- =====================================================
-- 2. TABLAS QUE FALTAN: videos y copy_templates
-- =====================================================

-- Tabla: videos (para TopView Avatar 4 IA)
...
-- Tabla: copy_templates (para copywriting)
...
-- =====================================================
-- 4. ACTUALIZAR social_posts para referenciar videos
-- =====================================================
...
BEGIN
  ...
  IF NOT EXISTS (
    ...
    ALTER TABLE public.social_posts 
    ADD COLUMN analytics_updated_at timestamp with time zone;
  END IF;
END $$;
...
-- =====================================================
-- 6. FUNCIONES ÚTILES (solo si no existen)
-- =====================================================
...
SELECT 
  'copy_templates', 
  COUNT(*) 
FROM public.copy_templates;

-- =====================================================
-- ✅ COMPLETADO - SQL SEGURO
-- =====================================================
