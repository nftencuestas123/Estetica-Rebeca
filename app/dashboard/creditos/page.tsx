    ...
    <div className="min-h-screen p-8" style={{ backgroundColor: '#FAF7F5' }}>
      ...
      <div className="max-w-4xl mx-auto">
        <div className="p-8 rounded-3xl" style={{ backgroundColor: '#E8D5D5' }}>
          <CreditCard className="w-12 h-12 mb-4" style={{ color: '#C9A961' }} />
          <h1 className="text-3xl font-light mb-4" style={{ color: '#5A4A42' }}>
            Mis Créditos
          </h1>
          <p style={{ color: '#8A7A72' }}>
            Esta funcionalidad usa el mismo sistema que en el admin.
            Redirige a /admin/creditos/comprar
          </p>
          <Link href="/admin/creditos/comprar" className="mt-4 inline-block px-6 py-3 rounded-full" style={{ backgroundColor: '#C9A961', color: '#FAF7F5' }}>
            Comprar Créditos
          </Link>
        </div>
      </div>
