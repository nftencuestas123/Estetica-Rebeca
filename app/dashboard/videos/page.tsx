    ...
    <div className="min-h-screen p-8" style={{ backgroundColor: '#FAF7F5' }}>
      ...
      <div className="max-w-4xl mx-auto">
        <div className="p-8 rounded-3xl" style={{ backgroundColor: '#E8D5D5' }}>
          <Video className="w-12 h-12 mb-4" style={{ color: '#C9A961' }} />
          <h1 className="text-3xl font-light mb-4" style={{ color: '#5A4A42' }}>
            Crear Videos con IA
          </h1>
          <p style={{ color: '#8A7A72' }}>
            Usa el sistema completo de videos IA + publicación automática.
          </p>
          <Link href="/admin/videos-ia-v2" className="mt-4 inline-block px-6 py-3 rounded-full" style={{ backgroundColor: '#C9A961', color: '#FAF7F5' }}>
            Ir a Videos IA
          </Link>
        </div>
      </div>
