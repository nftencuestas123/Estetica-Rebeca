            ...
            {SERVICIOS.faciales.map((servicio, index) => {
              ...
              >
                ...
                <div className="p-8">
                  ...
                  <p className="text-lg font-bold text-gray-600">100% natural</p>
                </div>
              </div>
              )
            })}
            ...
            {SERVICIOS.corporales.map((servicio, index) => {
              ...
              >
                ...
                <div className="p-8">
                  ...
                  <p className="text-lg font-bold text-gray-600">Renovación total</p>
                </div>
              </div>
              )
            })}
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10">
            {SERVICIOS.maquillaje.map((servicio, index) => {
              ...
              >
                ...
                <div className="p-8">
                  <h3 className="font-black text-2xl text-gray-900 mb-4 leading-tight">{servicio}</h3>
                  <p className="text-lg font-bold text-gray-600">Look natural</p>
                </div>
              </div>
              )
            })}
