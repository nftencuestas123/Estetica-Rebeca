  ...
  return (
    <div className="relative z-10 max-w-5xl mx-auto text-center px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        <span
          className="block text-primary-100 mt-2 sm:mt-4"
          style={{
      ...
      <motion.p
        ...
        className="text-base sm:text-lg md:text-xl lg:text-2xl font-light text-primary-200 mb-8 sm:mb-12 max-w-3xl mx-auto leading-relaxed px-4 sm:px-6"
        style={{
          transform: `translate(${mousePosition.x * 0.01}px, ${mousePosition.y * 0.01}px)`,
        }}
      >
        Tratamientos de estética avanzada con{' '}
        <span className="font-semibold text-primary-300">tecnología de última generación</span> y
      ...
      >
        <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
          ...
          >
            <span className="relative z-10 flex items-center gap-2 sm:gap-3 text-primary-100">
        ...
        <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
          <Link
            href="/tratamientos"
            className="px-6 sm:px-8 py-3 sm:py-4 bg-cream-100/90 backdrop-blur-sm border-2 border-primary-200 text-primary-200 rounded-full font-semibold text-base sm:text-lg hover:bg-cream-200 hover:border-primary-400 transition-all flex items-center gap-2 sm:gap-3 shadow-lg w-full sm:w-auto justify-center"
          >
      ...
      <motion.div
        ...
        className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-8 text-xs sm:text-sm text-primary-200 font-light px-4"
      >
